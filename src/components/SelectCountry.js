...
export default function SelectCountry() {
    // set country to global state in context
    const data = useContext(CountryContext);

    const classes = useStyles();
    // state to set selected country name
